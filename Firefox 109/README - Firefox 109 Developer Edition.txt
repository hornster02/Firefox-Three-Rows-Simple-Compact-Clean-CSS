...
Bugs (userChrome.css)
-the bar with open panels can be ridiculously large in height - the problem is related to the size of the titlebar in Windows - it can be reduced via the "Winaero Tweaker" submenu "Window Title Bars". If you don't want to change the system size of the titlebar, then "otevøené panely - zmenšit výšku lišty" may be useful - but in this case the fullscreen mode (F11) may be disturbed. It may also be useful to move the panels a few pixels as needed - search for the line "otevøené panely - posunutí". Also, for some skins, the colour of certain interface elements may be forced by me in a less than ideal way
-address bar may be too high and partially cropped - edit "posunout celé rozhraní dolù"
...
-Firefox instalátory se mohou programem WinRar rozbalit a následnì používat bez nutnosti instalace. Profily se mohou vytváøet a spouštìt pøes firefox.exe -p
...
-lišta s otevøenými panely mùže být na výšku nesmyslnì velká - problém souvisí s velikostí "titlebar" ve Windows - zmenšit se mùže pøes program "Winaero Tweaker" podnabídka "Window Title Bars". Pokud nechcete mìnit systémovou velikost "titlebar", tak se mùže hodit "otevøené panely - zmenšit výšku lišty" - v tomto pøípadì ale mùže dojít k narušení fullscreen režimu (F11). Mùže se také hodit posunutí panelù o pár pixelù podle potøeby - vyhledat øádek "otevøené panely - posunutí". U nìkterých skinù také mùže být mnou ne úplnì ideálnì vynucená barva urèitých prvkù rozhraní
-adresní øádek mùže být moc vysoko a èásteènì oøíznutý - upravit "posunout celé rozhraní dolù"
...
* vypnutí stahování+upozoròování na aktualizace - zakázat pøístup k update složkám "C:\ProgramData\Mozilla\..." a "c:\Users\XXX\AppData\Local\Mozilla\Firefox\..."
