...
Firefox 119 - Compact default CSS - 150% DPI. 231px vs 132px vs 72px (default vs 3-LINE vs 1-LINE - 150% DPI with "find on page" bar). 20 opened tabs
...
Firefox 119 - default - 100% DPI. 30 opened tabs
...
Firefox (150% DPI) - urlbar. "width" (userChrome.css *06) and "browser.urlbar.maxRichResults" (about:config or user.js). Dark space - The best dynamic theme
