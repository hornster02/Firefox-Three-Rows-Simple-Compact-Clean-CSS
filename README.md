...
Firefox 119 (2023) - Compact default CSS - 231px vs 132px vs 72px (default vs 3-LINE vs 1-LINE - 150% DPI with "find on page" bar) - 20 opened tabs - 150% DPI
...
Firefox 119 (2023) - default - 30 opened tabs - 100% DPI
...
Firefox 99 (2022) - Compact -set via the customize toolbar - taskbar height - 33,5 tabs - smallest tab width (about:config "browser.tabs.tabMinWidth") - 150% DPI
