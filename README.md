...
Firefox Compact default (150% DPI). To restore all removed icons and buttons, ... delete everything from "alltabs-button" to "unified-extensions-button" (userChrome.css). Firefox 109.rar+
