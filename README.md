...
Firefox Compact default (150% DPI). To restore all removed icons, buttons, ... delete everything from "alltabs-button" to "unified-extensions-button" (userChrome.css). And "places.xhtml" (userContent.css). Firefox 109.rar+
